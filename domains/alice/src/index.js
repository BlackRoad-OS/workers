export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'alice-blackroadio' });
    if (url.pathname === '/api') return Response.json({ section: 'alice', title: 'Alice', tagline: 'Alice — the autonomous operator agent of BlackRoad OS. Routing, automation, and DevOps at scale.' });
...
<title>Alice — BlackRoad OS</title>
<meta name="description" content="Alice — the autonomous operator agent of BlackRoad OS. Routing, automation, and DevOps at scale.">
...
<header>
  <div class="eye">BlackRoad OS · alice.blackroad.io</div>
  <h1>🚪 Alice</h1>
  <p class="sub">Alice — the autonomous operator agent of BlackRoad OS. Routing, automation, and DevOps at scale.</p>
  <nav>
...
<div class="body">
  <p style="font-size:.85rem;opacity:.4">Coming soon — Alice for BlackRoad OS</p>
</div>
<footer>alice.blackroad.io · © 2026 BlackRoad OS, Inc. · <a href="https://blackroad.io" style="color:#FF1D6C;text-decoration:none">blackroad.io</a></footer>
</body></html>`;
}
