export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroadqi-root' });
...
<title>BlackRoadQi</title><meta name="description" content="Quantum intelligence for the BlackRoad OS agent mesh. Trinary logic meets real-time inference.">
...
<div class="icon">⚡</div>
<h1>BlackRoadQi</h1>
<p>Quantum intelligence for the BlackRoad OS agent mesh. Trinary logic meets real-time inference.</p>
...
<footer>blackroadqi.com · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
