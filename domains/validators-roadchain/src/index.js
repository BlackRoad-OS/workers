export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'validators-roadchain' });
...
<title>Validators — RoadChain</title>
...
<div class="header">
  ...
  <h1>🛡️ Validators</h1>
  <p>Active validator set powering RoadChain consensus. 21 validators with stake, uptime, and performance metrics.</p>
</div>
