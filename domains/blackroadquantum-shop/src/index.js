export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroadquantum-shop' });
...
<footer>blackroadquantum.shop · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
