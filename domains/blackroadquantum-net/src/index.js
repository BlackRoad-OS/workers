export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroadquantum-net' });
...
<footer>blackroadquantum.net · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
