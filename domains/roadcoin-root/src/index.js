export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'roadcoin-root' });
...
<title>RoadCoin</title><meta name="description" content="The native currency powering the BlackRoad OS ecosystem and agent economy.">
...
<div class="icon">🪙</div>
<h1>RoadCoin</h1>
<p>The native currency powering the BlackRoad OS ecosystem and agent economy.</p>
...
<footer>roadcoin.io · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
