export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'chain-roadchain' });
...
<title>Chain Explorer — RoadChain</title>
...
<div class="header">
  ...
  <p>Real-time blockchain explorer for the RoadChain network. Browse transactions, blocks, and smart contracts.</p>
</div>
