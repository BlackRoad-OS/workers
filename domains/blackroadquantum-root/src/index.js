export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroadquantum-root' });
...
<title>BlackRoad Quantum</title><meta name="description" content="Quantum computing research division of BlackRoad OS. ZK proofs, quantum algorithms, post-quantum cryptography.">
...
<p>Quantum computing research division of BlackRoad OS. ZK proofs, quantum algorithms, post-quantum cryptography.</p>
...
<footer>blackroadquantum.com · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
