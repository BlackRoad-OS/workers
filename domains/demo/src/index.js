export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'demo-blackroadio' });
    if (url.pathname === '/api') return Response.json({ section: 'demo', title: 'Demo', tagline: 'Live demos of BlackRoad OS features. Try agents, skills, memory, and the CLI in your browser.' });
...
<title>Demo — BlackRoad OS</title>
<meta name="description" content="Live demos of BlackRoad OS features. Try agents, skills, memory, and the CLI in your browser.">
...
<header>
  <div class="eye">BlackRoad OS · demo.blackroad.io</div>
  <h1>🎮 Demo</h1>
  <p class="sub">Live demos of BlackRoad OS features. Try agents, skills, memory, and the CLI in your browser.</p>
  <nav>
...
<div class="body">
  <p style="font-size:.85rem;opacity:.4">Coming soon — Demo for BlackRoad OS</p>
</div>
<footer>demo.blackroad.io · © 2026 BlackRoad OS, Inc. · <a href="https://blackroad.io" style="color:#FF1D6C;text-decoration:none">blackroad.io</a></footer>
</body></html>`;
}
