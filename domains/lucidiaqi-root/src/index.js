export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'lucidiaqi-root' });
...
<title>LucidiaQi</title><meta name="description" content="Lucidia — the philosopher AI of BlackRoad OS. Deep reasoning, meta-cognition, and emergent intelligence.">
...
<div class="icon">🌀</div>
<h1>LucidiaQi</h1>
<p>Lucidia — the philosopher AI of BlackRoad OS. Deep reasoning, meta-cognition, and emergent intelligence.</p>
...
<footer>lucidiaqi.com · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
