export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'aliceqi-root' });
...
<title>AliceQi</title><meta name="description" content="Alice — the autonomous operator agent of BlackRoad OS. Routing, automation, and DevOps at scale.">
...
<div class="icon">🔵</div>
<h1>AliceQi</h1>
<p>Alice — the autonomous operator agent of BlackRoad OS. Routing, automation, and DevOps at scale.</p>
...
<footer>aliceqi.com · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
