export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroadinc-root' });
...
<title>BlackRoad Inc</title><meta name="description" content="BlackRoad OS, Inc. — building the next generation of AI-native operating systems and developer infrastructure.">
...
<div class="icon">🏢</div>
<h1>BlackRoad Inc</h1>
<p>BlackRoad OS, Inc. — building the next generation of AI-native operating systems and developer infrastructure.</p>
...
<footer>blackroadinc.us · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
