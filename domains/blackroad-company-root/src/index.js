export default {
  async fetch(req, env) {
    ...
    if (url.pathname === '/health') return Response.json({ ok: true, worker: 'blackroad-company-root' });
...
<title>BlackRoad Company</title><meta name="description" content="BlackRoad OS, Inc. — Your AI. Your Hardware. Your Rules. 30,000 agents. 1,825+ repos. 17 organizations.">
...
<h1>BlackRoad Company</h1>
<p>BlackRoad OS, Inc. — Your AI. Your Hardware. Your Rules. 30,000 agents. 1,825+ repos. 17 organizations.</p>
...
<footer>blackroad.company · © 2026 BlackRoad OS, Inc. All rights reserved.</footer>
</body></html>`;
}
